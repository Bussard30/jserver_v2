...
public class SerializationManager {
    private static final HashMap<Class<?>, Serializer> assignments;
    ...
    public static void register(Serializer o) throws InvalidParameterException {
        try {
    ...
    /**
     * Returns a string for an object that can be converted back to an object using {@link SerializationManager#getObject(Class, String)}
