...
import threading.exceptions.ThreadJobNotDoneException;
...
public class ThreadPool {
    ...
    /**
     * @param t      job that was finished
     * @param result result of that job
     */
     ...
     * @param e      exception thrown while executing task
     */
