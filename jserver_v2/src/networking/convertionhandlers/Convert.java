...
public class Convert
{
	...
	public static void register(ConvertionHandler o) throws InvalidParameterException
	{
		try
		{
			if (!assignments.containsKey(o.getClass().getAnnotation(networking.types.ConvertionHandler.class).target()))
			{
				assignments.put(o.getClass().getAnnotation(networking.types.ConvertionHandler.class).target(), o);
			} else
			{
